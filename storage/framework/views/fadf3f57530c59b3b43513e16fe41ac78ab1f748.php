                        ...
                        <div class="form-group col-md-12 mb-2">
                            ...
                            <select class="form-control" name="final_action_taken" required>
                                ...
                                <?php foreach ($final_actions as $row) : ?>
                                    <option value="<?php echo e($row->action_id); ?>"><?php echo e($row->action_name); ?> </option>
                                    <?php endforeach; ?>`
...
</div><?php /**PATH C:\xampp\htdocs\CPESD-MIS2.0\resources\views/dts/receiver/contents/incoming/modal/final_action_modal.blade.php ENDPATH**/ ?>