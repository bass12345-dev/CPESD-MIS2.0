	...
	<div class="sidebar-content js-simplebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item <?= $segments[2] == 'removed' ? 'active' : '' ?>">
				<a class="sidebar-link" href="<?php echo e(url('/watchlisted/user/removed')); ?>">
...
</nav><?php /**PATH C:\xampp\htdocs\CPESD-MIS2.0\resources\views/watchlisted/users/layout/user_watchlisted_includes/user_watchlisted_sidebar.blade.php ENDPATH**/ ?>