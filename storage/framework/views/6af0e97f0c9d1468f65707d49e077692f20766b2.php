            ...
            <?php foreach ($outgoing_history as $row) : ?>
               <tr>
                  ...
                  <td><?php
                        ...
                        echo $status;
                  ?></td>
                  <td><?php echo e(date('M d Y h:i A', strtotime($row->outgoing_date))); ?></td>
...
</div><?php /**PATH C:\Apache24\htdocs\CPESD-MIS2.0\resources\views/dts/users/contents/track/sections/document_information.blade.php ENDPATH**/ ?>