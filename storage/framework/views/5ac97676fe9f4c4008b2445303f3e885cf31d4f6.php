                ...
                <?php
                   ...
                   foreach ($list as $row) :?>
                     <tr>
                        ...
                        <td> 
                           <a href="<?php echo e(url('/watchlisted/admin/view_profile?id='.$row->person_id)); ?>" class="btn btn-primary"><i class="fas fa-eye"></i></a>   
...
<?php /**PATH C:\xampp\htdocs\CPESD-MIS\resources\views/watchlisted/admin/contents/restore/sections/restore_table.blade.php ENDPATH**/ ?>