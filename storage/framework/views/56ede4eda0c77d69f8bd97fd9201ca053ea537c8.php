      ...
      <form id="update_remarks_form">
               <div class="form-row mb-2">
                  <input type="hidden" value="<?php echo e($user_data->user_id); ?>" name="id">
                   ...
                   <input type="" name="remarks_document_id">
...
</div><?php /**PATH C:\xampp\htdocs\CPESD-MIS2.0\resources\views/dts/users/contents/forwarded/sections/remarks_update_modal.blade.php ENDPATH**/ ?>