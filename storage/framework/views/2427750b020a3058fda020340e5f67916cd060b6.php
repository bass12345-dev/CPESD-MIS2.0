                 ...
                 <td>    
                           <div class="btn-group dropstart">
                             ...
                             <ul class="dropdown-menu">
                                  ...
                                  <li><a class="dropdown-item" id="forward_icon" href="#" data-history-id="<?php echo e($row['history_id']); ?>" data-tracking-number="<?php echo e($row['tracking_number']); ?>"  data- data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">Forward</a></li>
                                </ul>
                           </div>
                        </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\CPESD-MIS2.0\resources\views/dts/users/contents/received/sections/received_table.blade.php ENDPATH**/ ?>