            ...
            <div class="col-sm-5">
                  ...
                  <div class="card documents_forwarded">
                     ...
                     <ul class="list-group list-group-flush">
                        ...
                        <?php endforeach; ?>
                        <li class="list-group-item text-danger"><a href="<?php echo e(url('/dts/user/forwarded')); ?>">See all</a></li>
...
</div><?php /**PATH C:\Apache24\htdocs\CPESD-MIS2.0\resources\views/dts/users/contents/dashboard/sections/count_section1.blade.php ENDPATH**/ ?>