            ...
            <div class="col-sm-5">
               <div class="card bg-danger count-total-final">
                  <div class="card-body">
                     ...
                     <h1 class="mt-1 mb-3 text-white"><?php echo e($count['final_receiver']); ?></h1>
                  </div>
               </div>
            </div>
...
<?php /**PATH C:\Apache24\htdocs\CPESD-MIS2.0\resources\views/dts/admin/contents/dashboard/sections/count_section1.blade.php ENDPATH**/ ?>