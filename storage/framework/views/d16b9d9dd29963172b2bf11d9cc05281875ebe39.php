...
<style type="text/css">
    body {
        background-image: url("<?php echo e(asset('assets/img/background-track.jpg')); ?>");
        background-size: cover;
        height: 100vh;
    }
</style><?php /**PATH C:\Apache24\htdocs\CPESD-MIS2.0\resources\views/dts/auth/includes/css.blade.php ENDPATH**/ ?>