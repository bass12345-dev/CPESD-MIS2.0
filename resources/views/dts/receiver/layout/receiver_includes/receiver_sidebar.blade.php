	...
	<div class="sidebar-content js-simplebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item <?= $segments[2] == 'dashboard' ? 'active' : '' ?>">
				<a class="sidebar-link" href="{{url('/dts/receiver/dashboard')}}">
					<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
				</a>
			</li>

			<!-- 		<li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/dts/receiver/pending')}}">
			...
			<li class="sidebar-item <?= $segments[2] == 'all-documents' ? 'active' : '' ?>">
				<a class="sidebar-link" href="{{url('/dts/receiver/all-documents')}}">
			...
			<li class="sidebar-item <?= $segments[2] == 'incoming' ? 'active' : '' ?>">
				<a class="sidebar-link" href="{{url('/dts/receiver/incoming')}}">
			...
			<li class="sidebar-item <?= $segments[2] == 'received' ? 'active' : '' ?>">
				<a class="sidebar-link" href="{{url('/dts/receiver/received')}}">
