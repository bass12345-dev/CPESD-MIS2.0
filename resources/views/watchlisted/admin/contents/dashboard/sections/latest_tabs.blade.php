            ...
            <div class="col-sm-7">
               ...
               <ul class="nav nav-tabs" role="tablist">
                     ...
                     <div class="tab-pane active" id="simple-tabpanel-0" role="tabpanel" aria-labelledby="simple-tab-0">
                           @include('watchlisted.admin.contents.dashboard.sections.tabs.added_today')
                     </div>
                     <div class="tab-pane" id="simple-tabpanel-1" role="tabpanel" aria-labelledby="simple-tab-1">
                           @include('watchlisted.admin.contents.dashboard.sections.tabs.approved_today')
                     </div>
                     <div class="tab-pane" id="simple-tabpanel-2" role="tabpanel" aria-labelledby="simple-tab-1">
                           @include('watchlisted.admin.contents.dashboard.sections.tabs.latest_approved')
                     </div>
                     </div>
